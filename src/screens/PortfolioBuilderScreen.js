    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyIcon}>Target</Text>
          ...
          <View style={styles.emptyHint}>
            <Text style={styles.hintText}>Tip: After solving a problem with 70%+, you can add it to your portfolio!</Text>
          </View>
        </View>
      </SafeAreaView>
    );
        ...
        {showStats && (
          <View style={styles.statsContainer}>
            <View style={styles.statGrid}>
              <StatItem icon="package" label="Items" value={stats.totalItems} />
              <StatItem icon="growth" label="Avg Score" value={`${stats.averageScore}%`} />
              <StatItem icon="star" label="Best" value={`${stats.bestScore}%`} />
              <StatItem icon="globe" label="Public" value={stats.publicCount} />
            </View>
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Notes Notes</Text>
    ...
    <View style={styles.itemCard}>
      ...
      {item.notes && (
        <View style={styles.notesPreview}>
          <Text style={styles.notesLabel}>Notes Notes</Text>
      ...
      <View style={styles.evaluationSummary}>
        <View style={styles.summaryItem}>
          <Text style={styles.summaryLabel}>Check Strengths</Text>
          <Text style={styles.summaryValue} numberOfLines={1}>
            {item.evaluation.strengths?.[0] || 'N/A'}
          </Text>
        </View>
        <View style={styles.summaryItem}>
          <Text style={styles.summaryLabel}>Growth Focus</Text>
          <Text style={styles.summaryValue} numberOfLines={1}>
